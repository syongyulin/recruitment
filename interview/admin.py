...
def notify_interviewer(modeladmin, request, queryset):
    ...
    # 这里的消息发送到钉钉，火车通过celery异步发送到钉钉
    send('候选人%s进入面试环节，亲爱的面试官，请准备好面试：%s'%(candidates,interviewers))
...
class CandidateAdmin(admin.ModelAdmin):
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        if 'interviewer' in group_names and obj.second_interviewer_user == request.user and obj.first_interviewer_user == obj.second_interviewer_user:
            return self.default_fieldsets_second
