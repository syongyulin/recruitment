...
class Candidate(models.Model):
    # 基础信息
    userid = models.IntegerField(unique=True, blank=True, null=True, verbose_name=_('应聘者ID'))
    ...
    test_score_of_general_ability = models.DecimalField(decimal_places=1, null=True, max_digits=3, blank=True,
                                                        verbose_name=_('综合能力测评成绩'))
    paper_score = models.DecimalField(decimal_places=1, null=True, max_digits=3, blank=True, verbose_name=_('笔试成绩'))

    # 第一轮面试记录
    first_score = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name=_('初试分',
    ...
    first_learning_ability = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True,
                                                 verbose_name=_('学习能力得分'))
    first_professional_competency = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True,
                                                        verbose_name=_('专业能力得分'))
    first_advantage = models.TextField(max_length=1024, blank=True, verbose_name=_('优势'))
    first_disadvantage = models.TextField(max_length=1024, blank=True, verbose_name=_('顾虑和不足'))
    first_result = models.CharField(max_length=256, choices=FIRST_INTERVIEW_RESULT_TYPE, blank=True,
                                    verbose_name=_('初试结果'))
    first_recommend_position = models.CharField(max_length=256, blank=True, verbose_name=_('推荐部门'))
    first_interviewer_user = models.ForeignKey(User, related_name='first_interviewer_user', blank=True, null=True, on_delete=models.CASCADE, verbose_name=_('面试官'))

    first_remark = models.CharField(max_length=135, blank=True, verbose_name=_('初试备注'))

    # 第二轮面试记录
    second_score = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name=_('专业复试得分'),
                                       help_text='1-5分，极优秀: >=4.5，优秀: 4-4.4，良好: 3.5-3.9，一般: 3-3.4，较差: <3分')
    ...
    second_pursue_of_excellence = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True,
                                                      verbose_name=_('追求卓越得分'))
    second_communication_ability = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True,
                                                       verbose_name=_('沟通能力得分'))
    second_pressure_score = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True,
                                                verbose_name=_('抗压能力得分'))
    second_advantage = models.TextField(max_length=1024, blank=True, verbose_name=_('优势'))
    second_disadvantage = models.TextField(max_length=1024, blank=True, verbose_name=_('顾虑和不足'))
    second_result = models.CharField(max_length=256, choices=INTERVIEW_RESULT_TYPE, blank=True, verbose_name=_('专业复试结果'))
    second_recommend_position = models.CharField(max_length=256, blank=True, verbose_name=_('建议方向或推荐部门'))
    ...
    second_remark = models.CharField(max_length=135, blank=True, verbose_name=_('专业复试备注'))

    # HR终面
    hr_score = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=_('HR复试综合等级'))
    hr_responsibility = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=_('HR责任心'))
    hr_communication_ability = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True,
                                                verbose_name=_('HR坦诚沟通'))
    hr_logic_ability = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=_('HR逻辑思维'))
    hr_potential = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=_('HR发展潜力'))
    hr_stability = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=_('HR稳定性'))
    hr_advantage = models.TextField(max_length=1024, blank=True, verbose_name=_('优势'))
    hr_disadvantage = models.TextField(max_length=1024, blank=True, verbose_name=_('顾虑和不足'))
    hr_result = models.CharField(max_length=256, choices=INTERVIEW_RESULT_TYPE, blank=True, verbose_name=_('HR复试结果'))
    ...
    hr_remark = models.CharField(max_length=256, blank=True, verbose_name=_('HR复试备注'))

    creator = models.CharField(max_length=256, blank=True, verbose_name=_('候选人数据的创建人'))
    created_date = models.DateTimeField(auto_now_add=True, verbose_name=_('创建时间'))
    modified_date = models.DateTimeField(auto_now=True, null=True, blank=True, verbose_name=_('更新时间'))
    last_editor = models.CharField(max_length=256, blank=True, verbose_name=_('最后编辑者'))

    class Meta:
        db_table = 'candidate'
        verbose_name = _('应聘者')
        verbose_name_plural = _('应聘者')
        permissions=[
            _('export','导出后选人列表'),
            _('notify','通知面试官面试')
        ]
